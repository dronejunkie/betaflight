...
// PG_TIMECONFIG
    ...
    { "rpm_gyro_lpf_min",  VAR_UINT16 | MASTER_VALUE, .config.minmaxUnsigned = { 0, 1000 }, PG_RPM_FILTER_CONFIG, offsetof(rpmFilterConfig_t, rpm_gyro_lpf_min) },
    { "rpm_gyro_lpf_max",  VAR_UINT16 | MASTER_VALUE, .config.minmaxUnsigned = { 0, 1000 }, PG_RPM_FILTER_CONFIG, offsetof(rpmFilterConfig_t, rpm_gyro_lpf_max) },
    ...
    { "rpm_dterm_lpf_type",  VAR_UINT8  | MASTER_VALUE | MODE_LOOKUP, .config.lookup = { TABLE_DTERM_LOWPASS_TYPE }, PG_RPM_FILTER_CONFIG, offsetof(rpmFilterConfig_t, rpm_dterm_lpf_type) },
#endif
